...
do_stage() {
	...
	install -d ${STAGING_BINDIR}/dspbridge/video/lib/pplib_dualout/inc
	cp -af ${S}/video/lib/pplib_dualout/inc/* ${STAGING_BINDIR}/dspbridge/video/lib/pplib_dualout/inc
	cp -af ${S}/video/lib/pplib_dualout/config.pl ${STAGING_BINDIR}/dspbridge/video/lib/pplib_dualout
}
