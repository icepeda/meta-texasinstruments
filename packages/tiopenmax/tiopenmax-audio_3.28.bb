...
SRC_URI = "\
	...
	file://23.11-ampthread.patch;patch=1 \
...
do_compile() {
	kwinject --config /data/apps/kw-server/config/kwfilter.conf -T ${HOME}/Documents/Klockworks/Audio_TRACE.tpl make \
		...
		aac_dec aac_enc armaac_dec armaac_enc g711_dec g711_enc g722_dec g722_enc g723_dec g723_enc g726_dec g726_enc \
...
#	kwadmin --host klocwork01.dal.design.ti.com --port 1116 delete-build WS_3630_OMX_Audio_Linux_23_Inc3 WS_3630_OMX_Audio_Linux_23_Inc3
	kwadmin --host klocwork01.dal.design.ti.com --port 1116 --verbose load WS_3630_OMX_Audio_Linux_23_Inc3 \
		${HOME}/Documents/Klockworks/Audio_TABLES --copy-sources --name 3630_OMX_Audio_Linux_23_Inc3_3
}
