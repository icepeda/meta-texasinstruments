...
SRC_URI = "\
	...
	file://23.13-rvdecmk.patch;patch=1 \
        file://23.15rmlcmldprintwmadec.patch;patch=1 \
        file://23.15rmlcmldprintg711dec.patch;patch=1 \
	file://23.15rmlcmldprintg722enc.patch;patch=1 \
        file://23.15rmlcmldprintg729dec.patch;patch=1 \
        file://23.15rmlcmldprintpcmenc.patch;patch=1 \
        file://setubaacdec.patch;patch=1 \
        file://setubaacenc.patch;patch=1 \
        file://setubamrenc.patch;patch=1 \
        file://setubamrdec.patch;patch=1 \
        file://setubpcmdec.patch;patch=1 \
        file://setubpcmenc.patch;patch=1 \
        file://setubwbamrdec.patch;patch=1 \
        file://setubwbamrenc.patch;patch=1 \
        file://setubmp3dec.patch;patch=1 \
	"
