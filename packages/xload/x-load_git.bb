...
SRC_URI = " \
${@base_contains("MACHINE", "omap-3630sdp", "git://git.omapzoom.org/repo/x-loader.git;branch=3630v0.1;protocol=http", "", d)} \
${@base_contains("MACHINE", "zoom3", "git://git.omapzoom.org/repo/x-loader.git;branch=zoom3;protocol=http", "", d)} \
"
